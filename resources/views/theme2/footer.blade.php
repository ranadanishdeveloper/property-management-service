    ...
    <div style="max-width: 1400px; margin: 0 auto; padding: 60px 30px 30px;">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px; margin-bottom: 40px;">
            <div>
                ...
                <p style="opacity: 0.8;">Finding your dream property with modern technology and expertise.</p>
            </div>
            <div>
                <h3 style="margin-bottom: 20px;">Quick Links</h3>
                <ul style="list-style: none;">
                    <li><a href="#" style="color: #fff; text-decoration: none; opacity: 0.8;">About</a></li>
                    <li><a href="#" style="color: #fff; text-decoration: none; opacity: 0.8;">Services</a></li>
                    <li><a href="#" style="color: #fff; text-decoration: none; opacity: 0.8;">Contact</a></li>
                </ul>
            </div>
            <div>
                <h3 style="margin-bottom: 20px;">Follow Us</h3>
                <div style="display: flex; gap: 15px;">
                    <a href="#" style="color: #fff; font-size: 24px;"><i class="fab fa-facebook"></i></a>
