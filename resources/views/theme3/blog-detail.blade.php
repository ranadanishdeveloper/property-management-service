...
<section class="theme3-blog-detail-section">
    <div class="theme3-container">
        ...
        <div class="theme3-blog-detail-header">
            ...
            <h1 class="theme3-blog-detail-title">{{ ucfirst($blog->title) }}</h1>

            <div class="theme3-blog-detail-meta">
                <div class="meta-item">
        ...
        <!-- Blog Content -->
        <div class="theme3-blog-detail-content">
            <div class="theme3-blog-content-wrapper">
                {!! $blog->content !!}
            </div>
        </div>

        <!-- Blog Footer - Share -->
        <div class="theme3-blog-detail-footer">
            <div class="theme3-share-section">
                <h4 class="theme3-share-title">{{ __('Share this article:') }}</h4>
                <div class="theme3-share-links">
