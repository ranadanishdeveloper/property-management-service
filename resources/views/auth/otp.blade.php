    ...
    {{-- <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="d-flex justify-content-center">
                    <div class="auth-header">
                        <h2 class="avtar avtar-xs btn-link-secondary text-secondary"><b>{{ __('Hi, Welcome Back') }} </b></h2>
            ...
            <div class="d-flex mt-1 justify-content-between">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="avtar avtar-xs btn-link-secondary text-secondary">{{ __('Forgot Password?') }}</a>
                @endif
            </div>
