{{ Form::open(['url' => 'blog', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    @php
        $subscriptionData = currentSubscription();
    @endphp
    @if ($subscriptionData['pricing_feature_settings'] === 'off' || $subscriptionData['subscription']->enabled_openai == 1)
        <div class="text-start">
            <a href="javascript:void(0)" class="btn btn-primary mb-2 aiModal" data-size="lg"
                data-url="{{ route('generate.template', ['blog']) }}" data-title="{{ __('AI Content Generator') }}">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('enabled', __('Enabled Blog'), ['class' => 'form-label']) }}
