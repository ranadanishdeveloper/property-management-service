                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                ...
                                                <h6 class="mb-0">
                                                    {{ !empty($tenant->family_member) ? $tenant->family_member : '-' }}
                                                </h6>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                ...
                                                <h6 class="mb-0">
                                                    {{ !empty($tenant->lease_start_date) ? dateFormat($tenant->lease_start_date) : '-' }}
                                                </h6>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0 text-muted text-sm">{{ __('Lease End Date') }} :</p>
                                                <h6 class="mb-0">
                                                    {{ !empty($tenant->lease_end_date) ? dateFormat($tenant->lease_end_date) : '-' }}
                                                </h6>
                                            </div>
