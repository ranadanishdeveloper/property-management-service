    ...
    @forelse ($blogs as $blog)
        ...
        <div class="glass-blog-card">
            ...
            <div class="glass-blog-info">
                ...
                <a href="{{ route('custom.domain.blog.detail', ['slug' => $blog->slug]) }}" class="glass-blog-readmore">Read More <i class="fas fa-arrow-right"></i></a>>Read More <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    @empty
